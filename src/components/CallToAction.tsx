...
export const CallToAction = () => {
  ...
  return (
    ...
    <div className="bg-black text-white py-[72px] sm:py-24 text-center" ref={containerRef}>
      ...
      <motion.div style={{translateY}}><Image src={sofaImage} alt="Image" className="absolute top-6 left-[calc(100%+36px)] sm:hidden"/></motion.div>
      <motion.div style={{translateY}}><Image src={bedImage} alt="Image" className="absolute -top-[120px] right-[calc(100%+24px)] sm:hidden"/></motion.div>
